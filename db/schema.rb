...
ActiveRecord::Schema.define(version: 20160626052731) do
  ...
  create_table "head_circs", force: :cascade do |t|
    t.integer  "chart_id"
    t.float    "value"
    t.datetime "date"
    t.datetime "created_at", null: false
  ...
  add_index "head_circs", ["chart_id"], name: "index_head_circs_on_chart_id"
